...
type GetMultiMetricHandlerArgs struct {
	Title      string                          `json:"title,omitempty" jsonschema:"description=Optional short title that explains what this query is trying to measure. Example: 'Checkout error rate in production'. This is for human readability and should summarize what is being queried."`
