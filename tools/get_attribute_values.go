...
type GetAttributeValuesHandlerArgs struct {
	...
	MetricName     string              `json:"metricName" jsonschema:"description=The name of the metric to get the possible attribute keys and values. This is only required if the type is metric"`
